const jobs = [
  {
    ...
    highlights: [
      ...
      'Desarrollo de interfaces y vistas de todos los modlos.',
      'Levantamiento de requerimientos den todas las areas de las empresas.',
  ...
  },
  {
    ...
    highlights: [
      'Administración y optimización de plataformas digitales institucionales.',
      'Gestión de CRM para seguimiento de prospectos, alumnos y procesos de inscripción.',
      'Análisis de datos y generación de reportes para apoyar estrategias de captación y campañas de marketing.',
      'Monitoreo de indicadores y seguimiento de resultados para la toma de decisiones.',
      'Coordinación de proyectos tecnológicos orientados a mejorar procesos administrativos y la experiencia de los usuarios.',
      'Colaboración y coordinación de equipos de trabajo multidisciplinarios para el cumplimiento de objetivos institucionales.',
      'Implementación de mejoras continuas en herramientas digitales, procesos y flujos de información.',
    ],
